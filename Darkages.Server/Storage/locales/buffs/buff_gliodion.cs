...
{
    public class buff_gliodion : Buff
    {
        /// <summary>
        ...
        public override void OnApplied(Sprite Affected, Buff buff)
        {
            if (Affected is Aisling)
                (Affected as Aisling)
                    .Client
                    .SendMessage(0x02, "Glioca has blessed you with the ultimate protection.");
        ...
        public override void OnEnded(Sprite Affected, Buff buff)
        {
            if (Affected is Aisling)
                (Affected as Aisling)
                    .Client
                    .SendMessage(0x02, "You hear Glioca's voice fade away....fear not young Aisling");
