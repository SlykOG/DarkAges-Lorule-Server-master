...
//                Spell.GiveTo(result, spell);
            ...
            if (result.Nation == 1)
            {
                result.LegendBook.AddLegend(new Legend.LegendItem
                {
                    ...
                    Value = string.Format("Saved by Fioschad")
                });
            }
            else if (result.Nation == 2)
            {
                result.LegendBook.AddLegend(new Legend.LegendItem
                {
                    ...
                    Color = (byte)LegendColor.Blue,
                    Icon = (byte)LegendIcon.Community,
                    Value = string.Format("Saved by Luathas")
                });
            }
            else if (result.Nation == 3)
            {
                result.LegendBook.AddLegend(new Legend.LegendItem
                {
                    ...
                    Color = (byte)LegendColor.Blue,
                    Icon = (byte)LegendIcon.Community,
                    Value = string.Format("Saved by Danaan")
                });
            }
            else if (result.Nation == 4)
            {
                result.LegendBook.AddLegend(new Legend.LegendItem
                {
                    Category = "Event",
                    Color = (byte)LegendColor.Blue,
                    Icon = (byte)LegendIcon.Community,
                    Value = string.Format("Saved by Gramail")
                });
            }
            return result;
        }
